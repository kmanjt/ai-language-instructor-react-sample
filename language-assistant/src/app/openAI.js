...
export const getChatGPTResponse = async (inputText) => {
  ...
  const context = "As a language teaching mentor, provide very concise and conversational guidance. Ask for additional context where required and keep all of your conversations related to learning languages, and avoid discussing anything inappropriate for professional environments.";
\\\
  try {
